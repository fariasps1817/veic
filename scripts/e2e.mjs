...
if (await documentInput.getAttribute('type') !== 'text') throw new Error('CPF não usa o tipo textual recomendado para identificadores.')
if (await documentInput.getAttribute('pattern') !== '[0-9]*') throw new Error('CPF não contém o padrão de compatibilidade numérica.')
...
if (await whatsappInput.getAttribute('type') !== 'text' || await whatsappInput.getAttribute('pattern') !== '[0-9]*') throw new Error('WhatsApp não usa a combinação móvel recomendada.')
...
if (await cepInput.getAttribute('type') !== 'text' || await cepInput.getAttribute('pattern') !== '[0-9]*') throw new Error('CEP não usa a combinação móvel recomendada.')
